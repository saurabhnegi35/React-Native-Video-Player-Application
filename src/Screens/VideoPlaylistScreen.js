...
//         <Text style={{color: 'black'}}> lkjsdasjdj </Text>
//         <Text style={{color: 'black'}}> lkjsdasjdj </Text>
//         <Text style={{color: 'black'}}> lkjsdasjdj </Text>
//         <Text style={{color: 'black'}}> lkjsdasjdj </Text>
//         <FlatList
...
const VideoPlaylistScreen = ({navigation}) => {
  const [currentVideo, setCurrentVideo] = useState(null);
  const [paused, setPaused] = useState(false);
  ...
  const playVideo = item => {
    ...
    navigation.navigate('VideoPlayer', {source: item});
  };
            ...
            <TouchableOpacity onPress={() => playVideo(item)}>
              ...
              <View style={styles.videoContainer}>
                ...
                <View style={styles.detailsContainer}>
                  ...
                  <Text style={styles.channelName}>{item.subtitle}</Text>
                </View>
              </View>
            </TouchableOpacity>
          )}
